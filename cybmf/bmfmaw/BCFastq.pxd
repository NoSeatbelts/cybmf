...
from bmfutil.cstring cimport cs_to_ph, cs_to_ia, PH2CHR_TRANS
from bmfutil.HTSUtils cimport chr2ph, chr2phStr, int2Str, ph2chrDict, cGetBS as getBS
from bmfutil.Inliners cimport Num2Nuc, Nuc2Num
from bmfmaw.Math cimport igamc, CHI2_FROM_PHRED, INV_CHI2_FROM_PHRED, arrmax
from pysam.cfaidx cimport kstream_t, kseq_t, kseq_init, kseq_read, kseq_destroy, ks_init, ks_destroy, ks_getuntil
