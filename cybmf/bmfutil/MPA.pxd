...
from bmfutil.Inliners cimport CigarOpToCigarChar, ChrToRefIDInline
from bmfutil.Inliners cimport chrInline, opLenToStr
from bmfutil.cstring cimport PH2CHR_TRANS
from bmfmaw.Math cimport CHI2_FROM_PHRED, INV_CHI2_FROM_PHRED, igamc, MergeAgreedQualities, MergeDiscQualities
...
ctypedef bmfutil.HTSUtils.BamTag BamTag_t
